...
GO
DBCC CHECKIDENT(N'[dbo].[DBG_SrvLogInfo]', RESEED, 8)
GO
...
GO
DBCC CHECKIDENT(N'[dbo].[Items_LootData]', RESEED, 142)
GO
...
GO
DBCC CHECKIDENT(N'[dbo].[ServerNotesData]', RESEED, 2)
GO
...
-- ----------------------------
CREATE INDEX [IX_ServerNotesData_GameServerId] ON [dbo].[ServerNotesData]
([GameServerId] ASC) 
GO
...
-- ----------------------------
CREATE INDEX [x_UsersInventory_Index_Fuck] ON [dbo].[UsersInventory]
([CharID] ASC) 
