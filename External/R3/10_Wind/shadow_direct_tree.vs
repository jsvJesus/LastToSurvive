 ...
 * @ Modified time: 2025-02-04 02:37
...
#endif
{
	...
	#ifdef	USE_AREF
		tc = (I.tc * consts).xy;
		wind_result = ssfx_wind_tree_branches(pos, H, tc.y, ssfx_wind_setup(), false);
	#else
		wind_result.xz = ssfx_wind_tree_trunk(pos, H, ssfx_wind_setup(), false).xy;
	#endif
