...
REG_VAR( d_discord_presence,		true,		VF_SAVE );
REG_VAR( d_discord_app_id,			"1515111956263211049", VF_SAVE );
...
REG_VAR( g_serverip,			"26.163.92.76",	0 ); // 66.180.197.56 - IP of dev server where we host dev master\supervisor
