...
#define eDISTANCE eDEFAULT
#define eINITIAL_OVERLAP eDEFAULT
#define impact position
#define isRigidActor() is<PxRigidActor>()
#define isRigidDynamic() is<PxRigidDynamic>()
#define isRigidStatic() is<PxRigidStatic>()
#define isRigidBody() is<PxRigidBody>()
#define setRigidDynamicFlag setRigidBodyFlag
#define getRigidDynamicFlags getRigidBodyFlags
#define PxRigidDynamicFlag PxRigidBodyFlag
#endif
