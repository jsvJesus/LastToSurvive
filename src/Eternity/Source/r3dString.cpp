...
static bool r3dIsReadableCString(const char* str)
{
	if(!str)
		return false;
...
{
  if(!r3dIsReadableCString(u.data) || !r3dIsReadableCString(str))
    return 0;
  return( stricmp( u.data, str) == 0 );
}
