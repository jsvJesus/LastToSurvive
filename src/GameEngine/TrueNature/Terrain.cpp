...
r3dTerrain::UpdatePhysHeightField ()
{
	...
	physicsHeightField = PxCreateHeightField(physicsHeightFieldDesc, g_pPhysicsWorld->PhysXSDK->getPhysicsInsertionCallback());
	...
	PxShape* aHeightFieldShape = R3DCreateTerrainShape(physicsTerrain, shapeGeom, *g_pPhysicsWorld->defaultMaterial);
