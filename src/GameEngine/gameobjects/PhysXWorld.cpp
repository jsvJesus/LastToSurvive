...
#ifndef _WIN64
#ifdef _WIN64
#define PHYSX_LIB_SUFFIX "_x64"
#else
#define PHYSX_LIB_SUFFIX "_x86"
#endif

#ifdef _DEBUG
#pragma comment(lib, "PhysX3CHECKED" PHYSX_LIB_SUFFIX ".lib")
#pragma comment(lib, "PhysX3CookingCHECKED" PHYSX_LIB_SUFFIX ".lib")
#pragma comment(lib, "PhysX3CHECKED" PHYSX_LIB_SUFFIX ".lib")
#pragma comment(lib, "PhysXProfileSDKCHECKED.lib")
#pragma comment(lib, "PhysXVisualDebuggerSDKCHECKED.lib")
#pragma comment(lib, "PhysX3CommonCHECKED" PHYSX_LIB_SUFFIX ".lib")
...
#pragma comment(lib, "PhysX3" PHYSX_LIB_SUFFIX ".lib")
#pragma comment(lib, "PhysX3Cooking" PHYSX_LIB_SUFFIX ".lib")
#pragma comment(lib, "PhysX3" PHYSX_LIB_SUFFIX ".lib")
#pragma comment(lib, "PhysXProfileSDK.lib")
#pragma comment(lib, "PhysXVisualDebuggerSDK.lib")
#pragma comment(lib, "PhysX3Common" PHYSX_LIB_SUFFIX ".lib")
...
#else // RELEASE
#ifndef WO_SERVER
#pragma comment(lib, "PhysX3PROFILE" PHYSX_LIB_SUFFIX ".lib")
#pragma comment(lib, "PhysX3CookingPROFILE" PHYSX_LIB_SUFFIX ".lib")
#pragma comment(lib, "PhysX3PROFILE" PHYSX_LIB_SUFFIX ".lib")
#pragma comment(lib, "PhysXProfileSDKPROFILE.lib")
#pragma comment(lib, "PhysXVisualDebuggerSDKPROFILE.lib")
#pragma comment(lib, "PhysX3CommonPROFILE" PHYSX_LIB_SUFFIX ".lib")
...
#ifdef WO_SERVER
#ifdef _DEBUG
#pragma comment(lib, "PhysX3CharacterKinematicCHECKED" PHYSX_LIB_SUFFIX ".lib")
#elif defined(FINAL_BUILD)
#pragma comment(lib, "PhysX3CharacterKinematic" PHYSX_LIB_SUFFIX ".lib")
#else // RELEASE
...
public:
	...
	virtual void reportError(PxErrorCode::Enum code, const char* message, const char* file, int line)
	{
		...
		if (strstr(message, "Deprecated mesh cooking format") != NULL)
		{
	...
	void onTrigger(PxTriggerPair *  pairs,  PxU32  count)
	{
		for(PxU32 i=0; i<count; ++i)
		{
            if(pairs[i].status == PxPairFlag::eNOTIFY_TOUCH_FOUND)
            {
                ...
                PhysicsCallbackObject* triggerObj = (PhysicsCallbackObject*)pairs[i].triggerActor->userData;
                r3d_assert(triggerObj);

                PhysicsCallbackObject* otherObj = (PhysicsCallbackObject*)pairs[i].otherActor->userData;
...
void PhysXWorld::Init()
{
	...
	if (PhysXPvd)
	{
		PhysXPvdTransport = PxDefaultPvdSocketTransportCreate("localhost", 5425, 1000);
	...
	CookingParams = new PxCookingParams(PhysXSDK->getTolerancesScale());
...
bool PhysXWorld::raycastSingle(const PxVec3& origin, const PxVec3& unitDir, const PxReal distance, PxSceneQueryFlags outputFlags, PxRaycastHit& hit, const PxSceneQueryFilterData& filterData /* = PxSceneQueryFilterData */)
{
    ...
    PxRaycastBuffer hitBuffer(hits, R3D_ARRAYSIZE(hits));
    ...
    g_pPhysicsWorld->PhysXScene->raycast(origin, unitDir, distance, hitBuffer, outputFlags, filterData);
...
bool PhysXWorld::CookMesh(const r3dMesh* orig_mesh, const char* save_as)
{
	...
	bool res = PxCookTriangleMesh(*CookingParams, meshDesc, PhysxUserFileWriteStream(cookedMeshFilename));
...
bool PhysXWorld::CookConvexMesh(const r3dMesh* orig_mesh, const char* save_as)
{
	...
	int len = strlen(cookedMeshFilename);
	r3dscpy(&cookedMeshFilename[len-3], "cpx");
	bool res = PxCookConvexMesh(*CookingParams, meshDesc, PhysxUserFileWriteStream(cookedMeshFilename));
...
#if !defined(FINAL_BUILD) && !defined(_WIN64)
#include "ObjManag.h"
#include "RepX/RepX.h"
