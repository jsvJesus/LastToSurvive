...
class r3dDX11LightingPass final
{
public:
    r3dDX11LightingPass();
    ~r3dDX11LightingPass();
...
private:
    ...
    r3dDX11VertexShader* FullscreenVS = nullptr;
    r3dDX11PixelShader* LightingPS = nullptr;

    r3dDX11InputLayout* InputLayout = nullptr;
    r3dDX11VertexBuffer* VertexBuffer = nullptr;

    r3dDX11ConstantBuffer FrameConstants;
    r3dDX11ConstantBuffer LightConstants;
