...
namespace
{
	using RmlFrontEndShopSizing::FShopGridSize;
	using RmlFrontEndShopSizing::GetShopGridSize;
	using RmlFrontEndShopSizing::GetShopItemSizeClass;
	using RmlFrontEndShopSizing::ShopGridCellSize;
	using RmlFrontEndShopSizing::ShopGridColumns;
