...
namespace lts::editor
{
    ...
    EditorTransformController::~EditorTransformController() noexcept
    {
    ...
    EditorInteractionResult EditorTransformController::Update(
    ...
    const EditorTransformVisualState&
        EditorTransformController::GetVisualState() const noexcept
    {
        return visualState_;
    }

    std::wstring EditorTransformController::BuildStatusText() const
    {
    ...
    bool EditorTransformController::IsViewportFocused() const noexcept
    {
        const HWND viewport = ToWindowHandle(viewportWindow_);
    ...
    bool EditorTransformController::WasPressed(
    ...
    bool EditorTransformController::BuildCurrentPickRay(
        EditorCameraController& camera,
        const engine::platform::WindowSize viewportSize,
    ...
    bool EditorTransformController::TryBeginDrag(
        EditorSceneDocument& document,
    ...
    bool EditorTransformController::UpdateDrag(
        EditorSceneDocument& document,
        EditorCommandHistory& history,
        EditorCameraController& camera,
    ...
    void EditorTransformController::EndDrag(
        EditorSceneDocument& document,
        EditorCommandHistory& history,
    ...
    void EditorTransformController::UpdateHotAxis(
    ...
    EditorTransformAxis EditorTransformController::PickAxis(
    ...
    DirectX::XMFLOAT3 EditorTransformController::GetAxisVector(
