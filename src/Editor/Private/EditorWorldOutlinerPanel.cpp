...
namespace lts::editor
{
    ...
    void EditorWorldOutlinerPanel::Draw(
    ...
    void EditorWorldOutlinerPanel::DrawEntity(
        const EditorEntityId entityId, EditorSceneDocument& document,
    ...
    void EditorWorldOutlinerPanel::HandleEntityDrop(
        const EditorEntityId targetId, EditorSceneDocument& document,
        EditorCommandHistory& history)
    {
