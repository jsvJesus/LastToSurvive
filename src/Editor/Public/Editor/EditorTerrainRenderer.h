...
{
class EditorTerrainRenderer final
{
public:
    EditorTerrainRenderer() noexcept; ~EditorTerrainRenderer() noexcept;
    EditorTerrainRenderer(const EditorTerrainRenderer&)=delete;
    EditorTerrainRenderer& operator=(const EditorTerrainRenderer&)=delete;
    ...
    [[nodiscard]] engine::graphics::GraphicsResult Render(
        engine::graphics::CommandContext& context,const EditorSceneDocument& document,
